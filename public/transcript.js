...
async function loadTranscript(lang=''){
  ...
  try{
    ...
    data=j;titleEl.textContent=j.title||'YouTube Video';authorEl.textContent=j.author?`by ${j.author}`:'';frame.src=`https://www.youtube.com/embed/${encodeURIComponent(j.videoId)}?enablejsapi=1&rel=0`;
